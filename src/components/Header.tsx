...
const Header = () => {
  ...
  return (
    <>
      <header className={`fixed top-[80px] left-0 w-full bg-white backdrop-blur-md z-50 transition-all duration-300 ${
      ...
      {/* 모바일 메뉴 */}
      <div className={`fixed inset-0 bg-black bg-opacity-50 z-[150] md:hidden transition-opacity duration-300 ${
        isMenuOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'
      }`} onClick={() => setIsMenuOpen(false)}>
        <div className={`fixed right-0 top-0 h-full w-64 bg-white shadow-xl transform transition-transform duration-300 z-[160] ${
