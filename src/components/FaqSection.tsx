    ...
    <section id="faq" className="container-custom bg-gray-50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <div
                key={index}
                className={`bg-white rounded-2xl shadow-lg overflow-hidden transition-all hover:shadow-xl ${openIndex === index ? 'ring-2 ring-primary' : ''
                  }`}
              >
                <button
                ...
                >
                  ...
                  <div className={`flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center transition-all ${openIndex === index ? 'bg-primary text-white' : 'bg-gray-100'
                    }`}>
                    <svg
        ...
        <div className="mt-16 bg-gradient-to-r from-primary to-blue-600 rounded-3xl p-8 md:p-12 text-white">
          ...
          <div className={`max-w-2xl mx-auto transition-all duration-500 overflow-hidden ${showEmailForm ? 'max-h-[800px] opacity-100' : 'max-h-0 opacity-0'
            }`}>
